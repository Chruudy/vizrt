        ...
        <div className="bg-brandBGLighter h-full p-4 col-span-2">
          <div className="relative">
            ...
            <select
              ...
              className="block appearance-none w-full bg-white border border-grey035 hover:border-grey070 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:bg-white focus:border-grey070"
            >
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="block appearance-none w-full bg-white border border-gray-400 hover:border-grey070 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:bg-white focus:border-grey070"
              >
        ...
        <div className="bg-brandBG p-4 col-span-10">
          <div className="mb-4">
            ...
            <select
              ...
              className="block appearance-none w-100 bg-white border border-grey035 hover:border-grey070 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:bg-white focus:border-grey070"
            >
