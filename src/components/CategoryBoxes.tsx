  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const productsWithBase64Images: Product[] = response.data.map(
          (product: any) => ({
            ...product,
        ...
        const sportProducts = productsWithBase64Images.filter(
  ...
  const renderProducts = (products: Product[]) => (
    <div className="flex flex-wrap -mx-2">
      {products.map((product) => (
        ...
        >
          <div className="w-full rounded-lg overflow-hidden shadow-lg p-4 bg-[#1D3641] text-white h-80 flex flex-col">
            {" "}
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-grey035 whitespace-nowrap">
                Category: {product.category}
              </p>
              <p className="text-md text-grey035 whitespace-nowrap">
                Price: ${product.price}
              </p>
            </div>
