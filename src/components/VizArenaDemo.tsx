...
const VizArenaDemo: React.FC = () => {
    ...
    return (
        <div>
            <div className="pt-8">
                <Link href="/">
                    <p className="text-white pl-12 font-medium">Back button</p>
                </Link>
            </div>
            ...
            <div className="pl-12 pt-8 relative flex ">
                ...
                <div className="w-1/2 bg-[#212121] rounded-2xl mx-12">
                    ...
                    <p className="text-white text-xl pb-6 px-6">
                    ...
                    <div className="flex space-x-4 justify-evenly ">
                        <Link href="/">
                            <button className="text-white font-medium text-lg rounded-lg px-6 py-3 w-56 bg-gradient-to-r from-orange-400 to-orange-700 shadow-lg transform hover:scale-105 transition-transform duration-200">
                                Demo
                            </button>
                        </Link>
