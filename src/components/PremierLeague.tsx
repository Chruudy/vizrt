        ...
        <div className="bg-[#1A323C] rounded-lg shadow-lg border-2 border-black border-opacity-20 p-4">
          <div className="flex items-center space-x-2">
            ...
            <StarIcon
              className={`text-3xl cursor-pointer ml-auto ${
                isStarClicked ? "text-yellow-500" : "text-white"
              }`}
          ...
          <div className="flex items-center justify-center mt-4 space-x-8 px-4">
            <Image
              ...
              alt="United Graphic 1"
            ></Image>
            <Image
              src={UnitedGraphic2}
              className="w-1/2 h-auto rounded-xl"
              alt="United Graphic 2"
            ></Image>
          </div>

          <div className="flex flex-wrap">
            <p className="text-white text-lg w-full md:w-1/2 pl-4 pt-6 md:pr-6">
              Enhance your Premier League broadcasts with our comprehensive
              Premier League Match Graphics Package. This package includes all
              the essential on-screen elements needed to deliver a professional
            ...
            <div className="ml-auto mr-4 mb-4 pb-4">
              <Link href="/">
                <button className="text-white font-medium text-lg rounded-lg px-6 py-3 w-56 bg-gradient-to-r from-brandOrange to-brandOrangeDarker shadow-lg transform hover:scale-105 transition-transform duration-200 mb-4 md:mb-0 md:mr-36">
                  Test
                </button>
              </Link>

              <Link href="/cart">
                <button className="text-white font-medium text-lg rounded-lg px-6 py-3 w-56 bg-gradient-to-r from-brandOrange to-brandOrangeDarker shadow-lg transform hover:scale-105 transition-transform duration-200 md:ml-4 md:mr-12">
        ...
        <div className="bg-[#1A323C] rounded-lg shadow-lg border-2 border-black border-opacity-20 p-4 flex items-start">
          <div className="pl-4 flex space-x-20">
            <div className="flex flex-col">
              <p className="text-white text-2xl font-medium pb-8">
                Graphic Elements Included
              </p>
              <div className="pb-4">
                <Image
                  src={PLScoreboard}
                  alt="Premier League Scoreboard Graphic"
                ></Image>
              </div>
              <div className="pb-4">
                <Image
                  src={PLCasters}
                  alt="Premier League Casters Graphic"
                ></Image>
              </div>
              <div className="pb-4">
            ...
            <div>
              <Image
                src={PLTable}
                alt="Premier League Table Graphic"
                className="w-48 h-auto pt-6"
              ></Image>
            </div>
          </div>
        </div>
