  ...
  return (
    <div className="flex flex-col justify-center items-center my-2">
      ...
      <Link href="/allProductsPage">
        <button className="my-8 px-4 py-2 text-base font-medium text-white rounded-md bg-gradient-to-r from-brandOrange to-brandOrangeDarker shadow-lg transform hover:scale-105 transition-transform duration-200">
          View all Products
        </button>
      </Link>
    </div>
