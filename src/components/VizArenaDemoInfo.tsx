        ...
        <div className="max-w-6xl mx-auto my-12 p-4 md:p-6 bg-gray-900 rounded-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 items-center">
                <div onClick={toggleImagePreview} className="cursor-pointer">
                    <Image src={VizArenaBg} alt="Viz Arena Demo Picture" className="w-full h-auto rounded-xl transform scale-100 md:scale-105" />
                </div>
                <div className="bg-gray-800 rounded-xl p-4 md:p-6 text-white">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <StarIcon className={`text-2xl md:text-3xl cursor-pointer ${isStarClicked ? 'text-yellow-500' : 'text-gray-300'}`} onClick={handleStarClick} aria-label="Toggle favorite" />
                    </div>
                    ...
                    <h2 className="text-lg md:text-xl font-semibold text-center my-2 md:my-4">Price: 1499kr</h2>
            ...
            {isPreviewOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center" onClick={toggleImagePreview}>
                    <div className="cursor-pointer" style={{ maxWidth: '60%', maxHeight: '100%' }}>
                        <Image src={VizArenaBg} alt="Viz Arena Demo Picture" layout="intrinsic" width={1200} height={675} objectFit="contain" />
                    </div>
                </div>
            )}
        </div>
