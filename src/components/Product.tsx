...
const Product: React.FC<ProductProps> = ({
  ...
  return (
    <div className="p-4 rounded-md flex flex-col justify-between mb-8" style={{ color: '#ffffff' }}>
      ...
      <button className="mt-4 text-base font-medium text-white w-full h-10 flex items-center justify-center rounded-md bg-gradient-to-r from-brandOrange to-orange-700 shadow-lg transform hover:scale-105 transition-transform duration-200">
        View Product
      </button>
      <Link href="/popular">
