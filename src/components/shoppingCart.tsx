      ...
      <div className="container mx-auto">
        ...
        <div className="bg-grey085 rounded-lg p-6 mb-6">
          {products.map((product, index) => (
            <div
              key={index}
              className="flex items-center mb-4 border-b border-grey075 pb-4"
            >
              ...
              <div className="flex ml-4 text-right">
                ...
                <button
                  className="text-white hover:text-red02"
        ...
        {transactionComplete ? (
          ...
          <>
            ...
            <div className="flex justify-end">
              <button
                className="bg-brandOrange text-white px-6 py-3 rounded-lg font-bold hover:bg-brandOrangeDarker transition duration-300"
