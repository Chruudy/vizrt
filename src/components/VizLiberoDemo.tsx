          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="logoUpload"
                  className="bg-white py-2 rounded-lg w-full pr-64 pl-1 font-medium text-base cursor-pointer"
                >
                  Upload Image
                </label>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <input
                ...
                value={possession1}
                onChange={handlePossession1Change}
              />
              ...
              <input
                ...
                placeholder="% Possession"
                value={possession2}
                onChange={handlePossession2Change}
              />
            </div>
            ...
            <div className="flex items-center justify-between space-x-2">
              <input
                type="number"
                className="bg-white py-2 rounded-lg w-1/3 px-3 font-medium text-base"
                placeholder="Left %"
              />
              <input
                type="number"
