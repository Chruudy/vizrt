...
const ProfileExperience: React.FC = () => {
  return (
    <div className="mt-8 flex justify-end"> {/* Changed to align items to the right */}
      <div>
        <h3 className="text-xl font-bold text-center text-white">Experience</h3>
        <div className="flex flex-col items-center mt-4 space-y-4">
          <div className="bg-white shadow-md rounded p-3 w-64 max-w-xs flex items-center"> {/* Adjusted width and padding */}
